...
public class Cpnt_CustomAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private ArrayList<Cpnt_DataFormat> infoList;
    private ViewHolder viewHolder;

    public Cpnt_CustomAdapter(Context c , ArrayList<Cpnt_DataFormat> array){
    ...
    public void setArrayList(ArrayList<Cpnt_DataFormat> arrays){
        this.infoList = arrays;
    }

    public ArrayList<Cpnt_DataFormat> getArrayList(){
        return infoList;
    }
